...
const dv12Descriptors = [
  ...
  ...Object.values(catalog.world.indexes.subjectPredicate?.shards ?? {}),
  ...Object.values(catalog.world.indexes.predicateObject?.shards ?? {}),
  ...Object.values(catalog.world.indexes.entityType?.shards ?? {}),
